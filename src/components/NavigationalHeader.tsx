    ...
    <header className="w-full fixed top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200 shadow-sm">
      <div className="max-w-[1400px] mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 pr-4 md:pr-8">
          ...
          {/* Call Button */}
          <a href="tel:+918178231291" className="flex items-center bg-primary text-white pl-4 pr-4 sm:pl-6 sm:pr-2 py-2 sm:py-2 rounded-sm hover:brightness-110 transition-all group border-b-4 border-[#C1121F] active:border-b-0 active:translate-y-1">
            <span className="hidden sm:inline-block font-poppins font-bold text-base md:text-xl tracking-tight mr-4">+91 817 823 1291</span>
